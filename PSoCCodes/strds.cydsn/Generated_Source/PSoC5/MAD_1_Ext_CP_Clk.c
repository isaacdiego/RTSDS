...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_Start
********************************************************************************
* Summary:
...
void MAD_1_Ext_CP_Clk_Start(void) 
{
    ...
    MAD_1_Ext_CP_Clk_CLKEN |= MAD_1_Ext_CP_Clk_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_Stop
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_StopBlock
********************************************************************************
* Summary:
...
{
    if (MAD_1_Ext_CP_Clk_CLKEN & MAD_1_Ext_CP_Clk_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = MAD_1_Ext_CP_Clk_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = MAD_1_Ext_CP_Clk_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(MAD_1_Ext_CP_Clk_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(MAD_1_Ext_CP_Clk_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_StandbyPower
********************************************************************************
* Summary:
...
void MAD_1_Ext_CP_Clk_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        MAD_1_Ext_CP_Clk_CLKSTBY &= ~MAD_1_Ext_CP_Clk_CLKSTBY_MASK;
    }
    else
    {
        MAD_1_Ext_CP_Clk_CLKSTBY |= MAD_1_Ext_CP_Clk_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MAD_1_Ext_CP_Clk_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = MAD_1_Ext_CP_Clk_GetSourceRegister();
    uint16 oldDivider = MAD_1_Ext_CP_Clk_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = MAD_1_Ext_CP_Clk_CLKEN & MAD_1_Ext_CP_Clk_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(MAD_1_Ext_CP_Clk_DIV_PTR, clkDivider);
                MAD_1_Ext_CP_Clk_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
        ...
        else
        {
            ...
            MAD_1_Ext_CP_Clk_CLKEN |= enabled;
        }
    }
}
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(MAD_1_Ext_CP_Clk_DIV_PTR);
}


/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MAD_1_Ext_CP_Clk_SetModeRegister(uint8 clkMode) 
{
    MAD_1_Ext_CP_Clk_MOD_SRC |= clkMode & MAD_1_Ext_CP_Clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MAD_1_Ext_CP_Clk_ClearModeRegister(uint8 clkMode) 
{
    MAD_1_Ext_CP_Clk_MOD_SRC &= ~clkMode | ~MAD_1_Ext_CP_Clk_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_GetModeRegister
********************************************************************************
* Summary:
...
{
    return MAD_1_Ext_CP_Clk_MOD_SRC & MAD_1_Ext_CP_Clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = MAD_1_Ext_CP_Clk_GetDividerRegister();
    uint8 oldSrc = MAD_1_Ext_CP_Clk_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        MAD_1_Ext_CP_Clk_MOD_SRC |= CYCLK_SSS;
        MAD_1_Ext_CP_Clk_MOD_SRC =
            (MAD_1_Ext_CP_Clk_MOD_SRC & ~MAD_1_Ext_CP_Clk_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return MAD_1_Ext_CP_Clk_MOD_SRC & MAD_1_Ext_CP_Clk_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    MAD_1_Ext_CP_Clk_PHASE = clkPhase & MAD_1_Ext_CP_Clk_PHASE_MASK;
}


/*******************************************************************************
* Function Name: MAD_1_Ext_CP_Clk_GetPhase
********************************************************************************
* Summary:
...
{
    return MAD_1_Ext_CP_Clk_PHASE & MAD_1_Ext_CP_Clk_PHASE_MASK;
}
